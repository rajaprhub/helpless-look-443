  ...
  return (
    <Box bg="black" mt="20px">
     <Box   justifyContent="center" p='2rem' display="flex">
      <Box w="5%" mt="20px" ><Image w="100%" borderRadius="14px" height="100%" 
       src={"https://apple-tv-clone-by-chetan.netlify.app/static/media/fiveI.a2de0e1309a764f9f3c0.jpg"}/></Box>
     </Box>
     <Box mt="-17px" 
     color="#ebebeb"
     textAlign="center" 
    //  border="solid red" 
     ...
     <Box ml="23%">
        <Box  w="70%" h="100px" >
            ...
            src={"https://apple-tv-clone-by-chetan.netlify.app/static/media/fiveI.a2de0e1309a764f9f3c0.jpg"} w="100%" h="100%" />
        </Box>
        ...
        <Box border="solid black" w="75%" ml="-20px" color="gray" >
            <Flex  cursor="pointer">
                <Box  >
                    ...
                    <Image 
                      src={"https://apple-tv-clone-by-chetan.netlify.app/static/media/fiveI.a2de0e1309a764f9f3c0.jpg"}/>
                    </Box>
                    <Box>
                ...
                <Box border="solid black" ml="31%" className={styles.imgDiv}>
                    <Image src={"https://apple-tv-clone-by-chetan.netlify.app/static/media/fiveI.a2de0e1309a764f9f3c0.jpg"}/>
                    </Box>
                    <Box>
